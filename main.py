...
async def process_model(callback_query: types.CallbackQuery, state: FSMContext):
    ...
    pen_info = {
        ...
        ("business",
         "профессионал"): "Модель Professional: надежная ручка с стальным пером и прочным металлическим корпусом. Отлично подходит для длительного использования.",
        ("business",
         "дипломат"): "Модель Diplomat: престижная ручка с платиновым покрытием и гравировкой. Прекрасный выбор для дипломатов и политиков.",
        ("economy",
         "студент"): "Модель Student: недорогая, но качественная ручка с эргономичной формой. Идеальна для студентов и школьников.",
        ("economy",
         "начинающий писатель"): "Модель Daily: практичная ручка для повседневного использования. Имеет удобную grip-зону и долговечные чернила.",
        ("economy",
         "начинающий дизайнер"): "Модель Basic: простая и надежная ручка для офисной работы. Экономичный выбор для больших организаций.",
        ("designer",
         "дизайнер"): "Модель Luxury: эксклюзивная ручка ручной работы с инкрустацией драгоценными камнями. Идеальный подарок для особых случаев.",
        ("designer",
         "писатель"): "Модель Anniversary: памятная ручка с возможностью персонализации. Отличный выбор для корпоративных юбилеев.",
        ("designer",
